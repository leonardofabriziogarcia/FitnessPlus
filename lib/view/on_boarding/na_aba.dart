import 'package:fitness/common_widget/pagina_borda.dart';
                ...
                Container(
                  ...
                  child: IconButton(icon: Icon( Icons.navigate_next, color: TColor.white, ), onPressed: (){
                      ...
                      if(selectPage < 3) {
                        ...
                        controller.animateToPage(selectPage, duration: const Duration(milliseconds: 200), curve: Curves.bounceOut);
