...
class AgachamentoGlobet extends StatefulWidget {
  const AgachamentoGlobet({super.key});

  @override
  State<AgachamentoGlobet> createState() => _AgachamentoGlobetState();
}

class _AgachamentoGlobetState extends State<AgachamentoGlobet> {
