...
class RoscaMartelo extends StatefulWidget {
  ...
  @override
  State<RoscaMartelo> createState() => _RoscaMarteloState();
}

class _RoscaMarteloState extends State<RoscaMartelo> {
  late CustomVideoPlayerController _customVideoPlayerController;

  Source currentSource = Source.Asset;

  
  String assetVideoPath = "assets/exercicios/Rosca_Martelo.mp4";
