...
class RoscaConcentrada extends StatefulWidget {
  const RoscaConcentrada({super.key});

  @override
  State<RoscaConcentrada> createState() => _RoscaConcentradaState();
}

class _RoscaConcentradaState extends State<RoscaConcentrada> {
